...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    c: common_vendor.o$1((...args) => $options.clean && $options.clean(...args))
  } : {}, {
    d: $props.insert || $data.show
  }, $props.insert || $data.show ? common_vendor.e({
    e: $props.left
  }, $props.left ? {
    f: common_vendor.o$1((...args) => $options.pre && $options.pre(...args))
  } : {}, {
    g: common_vendor.t(($data.nowDate.year || "") + " \u5E74 " + ($data.nowDate.month || "") + " \u6708"),
    h: $props.date,
    i: common_vendor.o$1((...args) => $options.bindDateChange && $options.bindDateChange(...args)),
    j: $props.right
  }, $props.right ? {
    k: common_vendor.o$1((...args) => $options.next && $options.next(...args))
  } : {}, {
    l: !$props.insert
  }, !$props.insert ? {
    m: common_vendor.o$1((...args) => $options.clean && $options.clean(...args))
  } : {}, {
    n: !$props.insert ? 1 : "",
    o: $props.showMonth
  }, $props.showMonth ? {
    ...
    z: common_vendor.o$1($options.choiceDate),
    A: common_vendor.o$1($options.handleMouse),
    ...
    D: common_vendor.o$1(($event) => $data.time = $event),
    E: common_vendor.p({
      type: "time",
    ...
    H: common_vendor.o$1(($event) => $data.timeRange.startTime = $event),
    I: common_vendor.p({
      type: "time",
      start: $options.reactStartTime,
      border: false,
    ...
    L: common_vendor.o$1(($event) => $data.timeRange.endTime = $event),
    M: common_vendor.p({
      type: "time",
      end: $options.reactEndTime,
      border: false,
    ...
    O: common_vendor.o$1((...args) => $options.confirm && $options.confirm(...args))
  } : {}, {
    P: !$props.insert ? 1 : "",
    Q: $data.aniMaskShow ? 1 : "",
    R: $data.aniMaskShow ? 1 : ""
  }) : {}, {
    S: common_vendor.o$1((...args) => $options.leaveCale && $options.leaveCale(...args))
  });
}
var Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "/Users/xunan/Projects/wxfishball/uni_modules/uni-datetime-picker/components/uni-datetime-picker/calendar.vue"]]);
