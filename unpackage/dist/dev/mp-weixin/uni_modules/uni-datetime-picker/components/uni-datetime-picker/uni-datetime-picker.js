...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    d: $data.singleVal,
    e: common_vendor.o$1(($event) => $data.singleVal = $event.detail.value)
  } : {
    f: common_vendor.p({
      type: "calendar",
      color: "#e1e1e1",
    ...
    i: common_vendor.o$1(($event) => $data.range.startDate = $event.detail.value),
    j: common_vendor.t($props.rangeSeparator),
    k: $options.endPlaceholderText,
    l: $data.range.endDate,
    m: common_vendor.o$1(($event) => $data.range.endDate = $event.detail.value)
  }, {
    ...
    p: common_vendor.o$1((...args) => $options.clear && $options.clear(...args))
  } : {}, {
    q: $props.disabled ? 1 : "",
    r: $props.border ? 1 : "",
    s: common_vendor.o$1((...args) => $options.show && $options.show(...args)),
    t: $data.popup,
    v: common_vendor.o$1((...args) => $options.close && $options.close(...args)),
    w: !$data.isPhone
    ...
    B: common_vendor.o$1(($event) => $data.tempSingleDate = $event.detail.value),
    C: $options.selectTimeText,
    D: !$data.tempSingleDate,
    E: $data.time,
    F: common_vendor.o$1(($event) => $data.time = $event.detail.value),
    G: common_vendor.o$1(($event) => $data.time = $event),
    H: common_vendor.p({
      type: "time",
      border: false,
    ...
    I: common_vendor.sr("pcSingle", "5f29a34c-4"),
    J: common_vendor.o$1($options.singleChange),
    K: common_vendor.p({
      showMonth: false,
    ...
    N: common_vendor.o$1((...args) => $options.confirmSingleChange && $options.confirmSingleChange(...args))
  } : {}, {
    ...
    S: common_vendor.o$1(($event) => $data.tempRange.startDate = $event.detail.value),
    T: $options.startTimeText,
    U: !$data.tempRange.startDate,
    V: $data.tempRange.startTime,
    W: common_vendor.o$1(($event) => $data.tempRange.startTime = $event.detail.value),
    X: common_vendor.o$1(($event) => $data.tempRange.startTime = $event),
    Y: common_vendor.p({
      type: "time",
      start: $options.reactStartTime,
      border: false,
    ...
    ac: common_vendor.o$1(($event) => $data.tempRange.endDate = $event.detail.value),
    ad: $options.endTimeText,
    ae: !$data.tempRange.endDate,
    af: $data.tempRange.endTime,
    ag: common_vendor.o$1(($event) => $data.tempRange.endTime = $event.detail.value),
    ah: common_vendor.o$1(($event) => $data.tempRange.endTime = $event),
    ai: common_vendor.p({
      type: "time",
      end: $options.reactEndTime,
      border: false,
    ...
    aj: common_vendor.sr("left", "5f29a34c-8"),
    ak: common_vendor.o$1($options.leftChange),
    al: common_vendor.o$1($options.updateRightCale),
    am: common_vendor.o$1($options.leftMonthSwitch),
    an: common_vendor.p({
      showMonth: false,
      ["start-date"]: $data.caleRange.startDate,
      ["end-date"]: $data.caleRange.endDate,
    ...
    ao: common_vendor.sr("right", "5f29a34c-9"),
    ap: common_vendor.o$1($options.rightChange),
    aq: common_vendor.o$1($options.updateLeftCale),
    ar: common_vendor.o$1($options.rightMonthSwitch),
    as: common_vendor.p({
      showMonth: false,
      ["start-date"]: $data.caleRange.startDate,
      ["end-date"]: $data.caleRange.endDate,
    ...
    aw: common_vendor.o$1((...args) => $options.clear && $options.clear(...args)),
    ax: common_vendor.t($options.okText),
    ay: common_vendor.o$1((...args) => $options.confirmRangeChange && $options.confirmRangeChange(...args))
  } : {}, {
    az: common_vendor.s($data.popover)
  }), {
    aA: $data.popup
  }) : {}, {
    aB: common_vendor.sr("mobile", "5f29a34c-10"),
    aC: $data.isPhone,
    aD: common_vendor.o$1($options.mobileChange),
    aE: common_vendor.p({
      clearDate: false,
      date: $data.defSingleDate,
...
var Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "/Users/xunan/Projects/wxfishball/uni_modules/uni-datetime-picker/components/uni-datetime-picker/uni-datetime-picker.vue"]]);
