...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    l: $data.focused,
    m: $props.autoHeight,
    n: common_vendor.o$1((...args) => $options.onInput && $options.onInput(...args)),
    o: common_vendor.o$1((...args) => $options.onBlur && $options.onBlur(...args)),
    p: common_vendor.o$1((...args) => $options.onFocus && $options.onFocus(...args)),
    q: common_vendor.o$1((...args) => $options.onConfirm && $options.onConfirm(...args))
  } : {
    ...
    C: $data.focused,
    D: $props.confirmType,
    E: common_vendor.o$1((...args) => $options.onFocus && $options.onFocus(...args)),
    F: common_vendor.o$1((...args) => $options.onBlur && $options.onBlur(...args)),
    G: common_vendor.o$1((...args) => $options.onInput && $options.onInput(...args)),
    H: common_vendor.o$1((...args) => $options.onConfirm && $options.onConfirm(...args))
  }, {
    ...
    L: common_vendor.o$1($options.onEyes),
    M: common_vendor.p({
    ...
    P: common_vendor.o$1(($event) => $options.onClickIcon("suffix")),
    Q: common_vendor.p({
    ...
    T: common_vendor.o$1($options.onClear),
    U: common_vendor.p({
      type: "clear",
...
var Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "/Users/xunan/Projects/wxfishball/uni_modules/uni-easyinput/components/uni-easyinput/uni-easyinput.vue"]]);
