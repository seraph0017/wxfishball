...
const PublicInstanceProxyHandlers = {
  get({ _: instance }, key) {
    ...
    if (publicGetter) {
      ...
      if (data2 !== EMPTY_OBJ && (key[0] === "$" || key[0] === "_") && hasOwn$1(data2, key)) {
...
function createScopedSlotInvoker(instance) {
  const invoker = (slotName, args, index2) => {
    ...
    const data2 = slot.fn(args, slotName + (hasIndex ? "-" + index2 : ""), index2);
...
const r$2 = (name, props, key) => renderSlot(name, props, key);
...
let titleJsons = {};
statConfig.appid = "";
titleJsons = { "pages/list/list": "\u9C7C\u4E38\u672D\u8BB0" };
